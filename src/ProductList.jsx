...
function ProductList({ onHomeClick }) {
    ...
    // Access cart state from Redux store to get total quantity
                    ...
                    <div> 
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                <span className="cart-count" style={{ fontSize: '20px', marginLeft: '5px' }}>
            ...
            <div key={idx} className="category-section">
                ...
                <div className="plants-grid">
                    {category.plants.map((plant, plantIdx) => {
                        const isAdded = isPlantAdded(plant.name);
                        return (
                            <div key={plantIdx} className="plant-card">
                                ...
                                <div className="plant-info">
                                    ...
                                    <button 
                                        className={`add-to-cart-btn ${isAdded ? 'added-to-cart' : ''}`}
